...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='New Quiz', max_length=255, verbose_name='Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('technique', models.IntegerField(choices=[(0, 'Multiple Choice'), (1, 'True/False'), (2, 'Fill in the Blank'), (3, 'Essay')], default=0, verbose_name='Difficulty')),
